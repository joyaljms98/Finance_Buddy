...
export default function AdminSidebarWrapper({ children }) {
    ...
    return (
        <AdminSidebarContext.Provider value={{ isSidebarOpen, setIsSidebarOpen }}>
            <div className="h-screen bg-slate-50 relative flex overflow-hidden">
                ...
                <RightSidebar isOpen={isRightSidebarOpen} toggleSidebar={() => setIsRightSidebarOpen(!isRightSidebarOpen)} basePath="/admin" />
            </div>

...
export default function AdminLayoutClient({ children }) {
    ...
    if (!isLoaded || !activeUser || activeUser.role !== 'Admin') {
        ...
        <>
            ...
            >
                ...
                <button
                    ...
                    className="bg-red-600 hover:bg-red-700 text-white p-4 rounded-full shadow-lg shadow-red-600/30 transition-all hover:scale-110 active:scale-95 flex items-center justify-center relative"
                    title="Quick Notes"
                >
                    <PenTool size={24} />
                    <span className="absolute -top-1 -right-1 bg-white w-3 h-3 rounded-full border-2 border-red-600"></span>
                </button>
            </div>
